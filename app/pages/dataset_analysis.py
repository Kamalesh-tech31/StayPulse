...
def render_dataset_analysis():
    ...
    st.subheader("Upload customer datasets and perform batch churn analysis")
    st.markdown("---")

    st.markdown(
        "Upload a CSV of customer records (columns should match the single prediction fields) and run batch prediction."
    )
